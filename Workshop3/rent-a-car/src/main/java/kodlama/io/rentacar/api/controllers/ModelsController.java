...
//controller mvc'de kullanılır html sayfası döner
@RestController // rest controller, api için kullanılır. controllerın genişletilmiş halidir. .json dönüşü sağlar. api standartlarına uygun şekilde.
@AllArgsConstructor
